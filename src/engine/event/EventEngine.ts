...
const EVENT_POOL: Omit<GameEvent, 'id'>[] = [
  // === L3: Normal events ===
  // USD
  { title: '美联储意外加息25个基点', description: '美联储宣布紧急加息，美元走强', targetAsset: 'KAL', priceImpact: 0.01, sentimentImpact: -5, tier: 3 },
  { title: '美国非农数据超预期', description: '就业市场强劲，美元指数攀升', targetAsset: 'KAL', priceImpact: 0.008, sentimentImpact: 3, tier: 3 },
  { title: '美国国债收益率飙升', description: '10年期美债收益率突破新高', targetAsset: 'KAL', priceImpact: 0.012, sentimentImpact: -4, tier: 3 },
  { title: '硅谷科技巨头财报亮眼', description: '科技股暴涨带动美元需求', targetAsset: 'KAL', priceImpact: 0.006, sentimentImpact: 5, tier: 3 },

  // EUR
  { title: '欧盟粮食大丰收', description: '创纪录粮食产量稳定欧元区物价', targetAsset: 'SRD', priceImpact: -0.005, sentimentImpact: 8, tier: 3 },
  { title: '欧洲央行暗示降息', description: '通胀回落，鸽派信号释放', targetAsset: 'SRD', priceImpact: -0.01, sentimentImpact: -3, tier: 3 },
  { title: '德国工业产出超预期', description: '制造业PMI重回扩张区间', targetAsset: 'SRD', priceImpact: 0.008, sentimentImpact: 6, tier: 3 },
  { title: '法国罢工潮持续', description: '全国性罢工影响欧元信心', targetAsset: 'SRD', priceImpact: -0.006, sentimentImpact: -4, tier: 3 },

  // GBP
  { title: '英国万亿基建计划', description: '英国政府公布万亿基建方案，英镑看涨', targetAsset: 'TDL', priceImpact: 0.01, sentimentImpact: 5, tier: 3 },
  { title: '印度稀土出口禁令', description: '印度限制稀土出口，英镑受益', targetAsset: 'TDL', priceImpact: 0.012, sentimentImpact: -3, tier: 3 },
  { title: '英国脱欧后贸易协议', description: '与亚太国家达成新自贸协定', targetAsset: 'TDL', priceImpact: 0.007, sentimentImpact: 4, tier: 3 },

  // CHF
  { title: '瑞士央行干预汇市', description: '瑞士央行出手稳定瑞郎汇率', targetAsset: 'DTR', priceImpact: -0.008, sentimentImpact: 2, tier: 3 },
  { title: '全球避险情绪升温', description: '地缘政治紧张推动资金流入瑞郎', targetAsset: 'DTR', priceImpact: 0.01, sentimentImpact: -6, tier: 3 },
  ...
  // GOLD
  { title: '瑞士银行挤兑潮', description: '多家瑞士银行出现挤兑，避险资产飙升', targetAsset: 'DGOLD', priceImpact: 0.02, sentimentImpact: -10, tier: 3 },
  { title: '南非金矿脉枯竭', description: '全球最大金矿宣布储量下调30%', targetAsset: 'DGOLD', priceImpact: 0.02, sentimentImpact: -5, tier: 3 },
  { title: '各国央行增持黄金', description: '新兴市场央行黄金储备创历史新高', targetAsset: 'DGOLD', priceImpact: 0.01, sentimentImpact: 3, tier: 3 },
  ...
  { title: '全球芯片短缺加剧', description: '供应链危机蔓延，伽蓝币承压', targetAsset: 'KAL', priceImpact: -0.008, sentimentImpact: -5, tier: 3 },
  ...
  { title: '伽蓝币体系崩溃', description: '多国宣布去伽蓝币化，信任危机爆发', targetAsset: 'KAL', priceImpact: -0.08, sentimentImpact: -25, tier: 4 },
  { title: '黄金发现超大型矿藏', description: '南极洲发现万亿级金矿，黄金暴跌', targetAsset: 'DGOLD', priceImpact: -0.1, sentimentImpact: 15, tier: 4 },
  { title: '全球央行联合降息', description: '六大央行同步降息至零，流动性洪灾', priceImpact: 0.04, sentimentImpact: 20, tier: 4 },
  { title: '核武器试验引爆恐慌', description: '某国进行地下核试验，避险情绪爆表', targetAsset: 'DGOLD', priceImpact: 0.06, sentimentImpact: -20, tier: 4 },
...
const EVENT_CHAINS: Record<string, { title: string; chance: number; delayTicks: number }[]> = {
  '美联储意外加息25个基点': [
    ...
    { title: '伽蓝币体系崩溃', chance: 0.1, delayTicks: 6 },
  ],
  '飓风摧毁休斯敦港口': [
